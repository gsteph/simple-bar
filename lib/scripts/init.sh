...
# $yabai_path -m signal --add event=space_changed action="echo '{\"type\":\"WIDGET_WANTS_REFRESH\",\"payload\":\"simple-bar-spaces-jsx\"}' | websocat - ws://127.0.0.1:41416/ -t --origin 'http://127.0.0.1:41416'"
...
####
############ lazem simple-bar howa el ye switch el space
############ ma yemken a3raf a7ot f init.sh eno ye switch bnafso
####

echo $(/usr/bin/curl 127.0.0.1:5000/all)
